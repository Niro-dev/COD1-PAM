...
onStartGameType()
{
	...
	{
		game["menu_moddownload"] = "moddownload"; //TODO: do i need it?
		game["menu_ingame"] = "ingame";
		game["menu_team"] = "team_" + game["allies"] + game["axis"];	// team_britishgerman
		game["menu_weapon_allies"] = "weapon_" + game["allies"];
		game["menu_weapon_axis"] = "weapon_" + game["axis"];
		game["menu_weapon_rifles"] = "weapon_rifles"; //TODO: not exist in cod1
		game["menu_serverinfo"] = "serverinfo_" + level.gametype;
		game["menu_callvote"] = "callvote";
		game["menu_exec_cmd"] = "exec_cmd"; //TODO: not exist in cod1
		game["menu_quickcommands"] = "quickcommands";
		game["menu_quickstatements"] = "quickstatements";
		game["menu_quickresponses"] = "quickresponses";
		game["menu_quicksettings"] = "quicksettings"; //TODO: not exist in cod1
		game["menu_mousesettings"] = "mousesettings"; //TODO: not exist in cod1
		game["menu_scoreboard"] = "scoreboard_sd"; //TODO: not exist in cod1
		game["menu_streamersystem"] = "streamersystem"; //TODO: not exist in cod1
		game["menu_strat_records"] = "strat_records"; //TODO: not exist in cod1
...
onConnected()
{
	...
	else if (self maps\mp\gametypes\_force_download::waitingForResponse()) //TODO: do i need it?
	{
	...
	else if (self maps\mp\gametypes\_force_download::modIsNotDownloadedForSure())//TODO: do i need it?
	{
		// dont open any menu
	}
...
onMenuResponse(menu, response)
{
	...
	if (maps\mp\gametypes\_force_download::modIsNotDownloadedForSure()) //TODO: do i need it?
		return true;

	// Not downloaded yet and still listening
	if(menu == game["menu_moddownload"] && response == "moddownloaded" && maps\mp\gametypes\_force_download::waitingForResponse())//TODO: do i need it?
	{
